%-----------------------------------------------------------------------------------------
% Peri-stimulus time histograms for odor-modulated neurons compared to other neurons
%
...
decoding_results_file = 'Fig-5-d-image-decoding';

plot_title = 'Image decoding';
plot_name  = 'Fig-5-d-image-decoding';
y_limits   = [0 35];
